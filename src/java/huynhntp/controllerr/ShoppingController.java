...
public class ShoppingController extends HttpServlet {
    ...
    private final static Logger LOGGER = Logger.getLogger(ShoppingController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            float toalRecord = dao.getTotalRecordActive();
            ...
            List<ProductDTO> list = dao.getForShopping(currenPage);
            ...
            LOGGER.error("Trouble at Shopping Controller :  "+  e.toString());
        }
        finally{
